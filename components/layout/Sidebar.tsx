...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={[
          "fixed left-0 top-0 z-30 h-screen w-64 bg-zinc-900 flex flex-col",
      ...
      >
        {/* Logo */}
        <div className="flex items-center justify-between px-5 h-16 border-b border-zinc-800 flex-shrink-0">
          <Link href="/" className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[10px] text-zinc-500 mt-0.5 leading-none">Agency Portal</p>
            </div>
          </Link>
          ...
          <button
            onClick={onClose}
            className="lg:hidden w-7 h-7 flex items-center justify-center rounded-md text-zinc-500 hover:text-zinc-300 hover:bg-zinc-800 transition-colors flex-shrink-0"
        ...
        <div className="px-3 py-4 border-t border-zinc-800 flex-shrink-0">
          <div className="flex items-center gap-3 px-2 py-2 rounded-lg hover:bg-zinc-800 transition-colors cursor-pointer group">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-zinc-500 truncate mt-0.5">agency@demo.com</p>
            </div>
            <svg

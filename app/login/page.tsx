            ...
            {showRoleChoice && (
              <div className="mt-3 grid grid-cols-2 gap-2">
                ...
                >
                  ...
                  <span className="text-[13px] font-semibold text-white/80">Agência</span>
                  <span className="text-[11px] text-white/35">Publique vagas</span>
                </Link>
                <Link
                ...
                >
                  ...
                  <span className="text-[13px] font-semibold text-white/80">Talento</span>
                  <span className="text-[11px] text-white/35">Candidate-se</span>
                </Link>
              </div>
            )}
          </div>

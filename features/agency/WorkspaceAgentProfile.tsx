...
export default function WorkspaceAgentProfile({
  userId,
  ...
  return (
    <div className="max-w-2xl space-y-8 pb-8">
      ...
      <div>
        <p className="text-[11px] font-semibold uppercase tracking-widest text-zinc-400 mb-1">Agente</p>
      ...
      <div className="flex items-center gap-5">
        ...
        <div>
          <p className="text-[14px] font-semibold text-zinc-900">{name || "Agente"}</p>
